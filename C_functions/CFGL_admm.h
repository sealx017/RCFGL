...
void fmgl_subfusedLasso_n(double* output, double* input, double* Weight,  const double* fx, const double* fy, const double lam, const double* rho, const int N, const int K, const size_t Num)
{
    size_t N2 = N*N;
