#---------Code to run FGL and CFGL on simulated datasets under scenario S2-------------
...
for(sim in 1:10){
  y1 = read.csv(paste0("/home/seals/CFGL/Codes/April29/simulation_data/3condition/twosame_morediff",
                       "p_",p,"_n_",n,"_condition_",1,"_sim_",sim,".csv"))
  
  y2 = read.csv(paste0("/home/seals/CFGL/Codes/April29/simulation_data/3condition/twosame_morediff",
                       "p_",p,"_n_",n,"_condition_",2,"_sim_",sim,".csv"))
  
  y3 = read.csv(paste0("/home/seals/CFGL/Codes/April29/simulation_data/3condition/twosame_morediff",
  ...
  for(i in 1:dim(lambdas)[1]){
    ...
    saveRDS(list(a1,t2+t3),file = paste0(folder_path, "Simulated_datasets/Results/R_res/3condition/
              CFGL_twosame_morediff_theta_", "p_",p,
